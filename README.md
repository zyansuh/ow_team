...
| 태블릿 | 640px~1024px | 폼 2열, 결과 2~3열, 브래킷 가로 스냅 스크롤 |
| 데스크톱 | 1024px 이상 | 폼 4열, 결과 최대 4열, 넓은 히어로·여백 |
...
개발자 도구에서 모바일 뷰포트로 미리 확인하는 것을 권장합니다.
...
5. 토너먼트에서 승자 선택 → 다음 라운드 진출 · 우승 팀 표시  
